...
with source_seed (
  ...
  values
    -- GPW: EODHD primary.
    ('XTB', 'GPW', 'eodhd', 'XTB.WAR', 1, 'GPW close; EODHD'),
    ('DIG', 'GPW', 'eodhd', 'DIG.WAR', 1, 'GPW close; EODHD'),
    ('SNT', 'GPW', 'eodhd', 'SNT.WAR', 1, 'GPW close; EODHD'),
    ('MBR', 'GPW', 'eodhd', 'MBR.WAR', 1, 'GPW close; EODHD'),
    ('PAS', 'GPW', 'eodhd', 'PAS.WAR', 1, 'GPW close; EODHD'),
    ('ABE', 'GPW', 'eodhd', 'ABE.WAR', 1, 'GPW close; EODHD'),
    ('TOA', 'GPW', 'eodhd', 'TOA.WAR', 1, 'GPW close; EODHD'),
    ('COG', 'GPW', 'eodhd', 'COG.WAR', 1, 'GPW close; EODHD'),
    ('RBW', 'GPW', 'eodhd', 'RBW.WAR', 1, 'GPW close; EODHD'),
    ('ASB', 'GPW', 'eodhd', 'ASB.WAR', 1, 'GPW close; EODHD'),
    ('KRU', 'GPW', 'eodhd', 'KRU.WAR', 1, 'GPW close; EODHD'),
    ('LPP', 'GPW', 'eodhd', 'LPP.WAR', 1, 'GPW close; EODHD'),
    ('KTY', 'GPW', 'eodhd', 'KTY.WAR', 1, 'GPW close; EODHD'),
    ('BDX', 'GPW', 'eodhd', 'BDX.WAR', 1, 'GPW close; EODHD'),
    ('CBF', 'GPW', 'eodhd', 'CBF.WAR', 1, 'GPW close; EODHD'),
    ('UNT', 'GPW', 'eodhd', 'UNT.WAR', 1, 'GPW close; EODHD'),
    ('ELT', 'GPW', 'eodhd', 'ELT.WAR', 1, 'GPW close; EODHD'),
    ('WPL', 'GPW', 'eodhd', 'WPL.WAR', 1, 'GPW close; EODHD'),
    ('ASE', 'GPW', 'eodhd', 'ASE.WAR', 1, 'GPW close; EODHD'),
    ('BFT', 'GPW', 'eodhd', 'BFT.WAR', 1, 'GPW close; EODHD'),
    ('NWG', 'GPW', 'eodhd', 'NWG.WAR', 1, 'GPW close; EODHD'),

    -- Xetra / LSE: Alpha Vantage global daily endpoint.
    ('XNAS.DE', 'XETRA', 'alpha_vantage', 'XNAS.DEX', 1, 'Xetra close; Alpha Vantage'),
    ('IS3N.DE', 'XETRA', 'alpha_vantage', 'IS3N.DEX', 1, 'Xetra close; Alpha Vantage'),
    ('IS3R.DE', 'XETRA', 'alpha_vantage', 'IS3R.DEX', 1, 'Xetra close; Alpha Vantage'),
    ('IWMO.UK', 'LSE', 'alpha_vantage', 'IWMO.LON', 1, 'LSE close; Alpha Vantage'),

    -- U.S. holdings: Alpha Vantage.
    ('CTRE', 'NYSE', 'alpha_vantage', 'CTRE', 1, 'US close; Alpha Vantage'),
    ('MAA', 'NYSE', 'alpha_vantage', 'MAA', 1, 'US close; Alpha Vantage'),
    ('EQIX', 'NASDAQ', 'alpha_vantage', 'EQIX', 1, 'US close; Alpha Vantage'),
    ('AVGO', 'NASDAQ', 'alpha_vantage', 'AVGO', 1, 'US close; Alpha Vantage'),
    ('MU', 'NASDAQ', 'alpha_vantage', 'MU', 1, 'US close; Alpha Vantage'),
    ('NVDA', 'NASDAQ', 'alpha_vantage', 'NVDA', 1, 'US close; Alpha Vantage'),
    ('TSM', 'NYSE', 'alpha_vantage', 'TSM', 1, 'US close; Alpha Vantage'),
    ('ASML', 'NASDAQ', 'alpha_vantage', 'ASML', 1, 'US close; Alpha Vantage'),
    ('SNDK', 'NASDAQ', 'alpha_vantage', 'SNDK', 1, 'US close; Alpha Vantage'),
    ('VRT', 'NYSE', 'alpha_vantage', 'VRT', 1, 'US close; Alpha Vantage'),
    ('ANET', 'NYSE', 'alpha_vantage', 'ANET', 1, 'US close; Alpha Vantage'),
    ('MPWR', 'NASDAQ', 'alpha_vantage', 'MPWR', 1, 'US close; Alpha Vantage'),
    ('CPT', 'NYSE', 'alpha_vantage', 'CPT', 1, 'US close; Alpha Vantage'),

    -- Crypto: Friday daily BTC/EUR candle.
    ('BTC', null, 'bitvavo', 'BTC-EUR', 1, 'Friday BTC/EUR daily close')
)

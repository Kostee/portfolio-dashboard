...
-- ============================================================
-- PROVIDER-SPECIFIC DAILY-OPEN MAPPINGS
-- ============================================================

-- Instrument/provider symbol mappings are deployment-specific configuration
-- and are intentionally not seeded by the public migration history.

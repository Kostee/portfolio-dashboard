...
At that point, positions covered by the automatic market-data and government-bond valuation workflows should already be ready. Enter manually only positions that do not have an automatic valuation source, such as employer pension or retirement accounts.
